...
<html>
    ...
    <body>
        ...
        <center>
        <h2>Registrarse</h2>
        <p>Apellidos(Paterno y Materno): <input type="text" name="apellidos"/></p>
        <p>Nombre: <input type="text" name="nombre"/></p>
        <p>Email: <input type="email" name="email"/></p>
        <p>Numero de telefono: <input type="tel" name="numero-de-telefono"/></p>
        <p>Contraseña: <input type="password" name="contrasena"/></p>
        <p>Fecha de nacimiento: <input type="date" name="fecha-de-nacimiento"/></p>
        <p>Pais : <select name="pais" id="pais">
        ...
        <p>Municipio: <select name="estado">
            <option value="no">Seleccione uno...</option>
            <option value="Aguascalientes">Aguascalientes</option>
            ...
            <option value="San Jose de Garcia">San Jose de Garcia</option>
            ...
            <p><button type="button">Registrarse</button>
            <p>Ya cuenta con un usuario? inicie sesion <a href="./login.html">aqui </a></p>
        </center>
        </section>
